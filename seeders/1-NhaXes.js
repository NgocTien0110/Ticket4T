    ...
    const items = [
      {
        ...
        imageCarCom: '/images/nhaxe/nxBaoCuc.png',
      },
      {
        name: 'Minh Phương',
      ...
      {
        name: 'Trường Giang',
        description: 'Bạn muốn đặt vé từ Điện Biên đi Sơn La? Bạn muốn đặt vé từ Điện Biên đi Hà Nội? Nhưng bạn không biết nên lựa chọn nhà xe khách nào? Ticket4T sẽ gửi đến bạn thông tin nhà xe Trường Giang chạy tuyến Điện Biên đi Hà Nội và Sơn La để bạn tham khảo cho dự định của bạn nhé\nNhà xe Trường Giang là nhà xe chuyên phục vụ tuyến Điện Biên – Hà Nội – Hà Nam và tuyến Điện Biên Sơn La. Các điểm ích lợi khi lựa chọn nhà xe bao gồm: Gối ôm, đèn đọc sách cá nhân, dây đai an toàn, nước khoáng đóng chai, chăn mềm, gối nằm, tủ lạnh mini, sạc điện thoại, điều hòa, khăn lạnh, wifi, búa phá kính phòng trường hợp khẩn cấp,…\nNhà xe Trường Giang còn ăn điểm của khách hàng ở thái độ phục vụ của nhà xe. Nhân viên hỗ trợ khách hàng rất nhiệt tình từ lúc quý khách bắt đầu tham khảo thông tin đặt vé cho đến khi khách hàng xuống xe. Đội ngũ lái xe đường dài đầy kinh nghiệm, nhân viên phụ xe lịch sự, nhiệt tình.',
        ...
        imageCarCom: '/images/nhaxe/nxTruongGiang.png'
      },
      {
        name: 'Xuân Hải',
        description: 'Tuyến Quảng Ngãi – Lâm Đồng là một tuyến đường vô cùng hấp dẫn trong thị trường vận tải tỉnh Quảng Ngãi. Có rất nhiều nhà xe nổi tiếng đang khai thác tuyến đường nhộn nhịp này. Hôm nay, Ticket4T sẽ giới thiệu đến chúng ta một trong những nhà xe nổi bật nhất tuyến Quảng Ngãi – Lâm Đồng đó chính là nhà xe Xuân Hải.\nNhà xe Xuân Hải còn được mọi người biết đến với tên gọi Công ty xe khách Xuân Hải chuyên vận chuyển hàng hoá, hành khách tuyến Quảng Ngãi – Lâm Đồng và ngược lại.\nVới phương châm làm việc: “ Đưa bạn đến chân trời mới – Đón bạn về với mái ấm”. Xuân Hải luôn mong muốn là người bạn đồng hành cùng hành khách đến những chân trời mới, khám phá những điều tuyệt vời nhất và trải nghiệm những dịch vụ đẳng cấp nhất\nXe Xuân Hải còn được hành khách quý như những chiến binh mạnh mẽ, ngang tàn luôn chinh phục mọi nẻo đường để hoàn thành sứ mệnh đưa đón hành khách đến nơi một cách an toàn.Đội ngũ tài xế lái xe lành nghề, có thâm niên, tay nghề vững chắc. Nhân viên của Xuân Hải luôn làm việc hết mình, sẵn sàng giúp đỡ, giải đáp những thắc mắc mà hành khách hay gặp phải.',
