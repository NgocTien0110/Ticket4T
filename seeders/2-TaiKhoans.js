    ...
    const items = [
      {
        ...
        , dob: '2002-12-04', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
      ...
      },
      {
        ...
        , dob: '2002-03-29', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
        email: 'dnt20@gmail.com', password: '123456', phoneNum: '0425678930', fullName: 'Đặng Ngọc Tiến'
        , dob: '2002-03-25', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
        email: 'hienphuong2008@gmail.com', password: '123456', phoneNum: '0315627890', fullName: 'Hiền Phương'
        , dob: '2006-03-04', sex: 'Nữ', imageAccount: '/images/accImageDefault-Nu.jpg', isAdmin: false
      },
      {
        email: 'nvv20@gmail.com', password: '123456', phoneNum: '0345672230', fullName: 'Nguyễn Văn Việt'
        , dob: '2002-10-04', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
        email: 'bhv20@gmail.com', password: '123456', phoneNum: '0234673890', fullName: 'Bùi Hoàng Vũ'
        , dob: '2002-02-12', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
        email: 'nav20@gmail.com', password: '123456', phoneNum: '0123671890', fullName: 'Ngô Anh Vũ'
        , dob: '2002-03-05', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      },
      {
        email: 'vhgt20@gmail.com', password: '123456', phoneNum: '0345621230', fullName: 'Võ Hoàng Gia Tín'
        , dob: '2002-03-15', sex: 'Nam', imageAccount: '/images/accImageDefault-Nam.jpg', isAdmin: false
      }];
    items.forEach(item => {
